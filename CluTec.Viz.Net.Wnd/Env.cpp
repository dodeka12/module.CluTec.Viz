	...
	namespace Viz
	{
		namespace Net
		{
			System::String^ Env::GetPath(Clu::Viz::Net::EnvPaths eEnvPath)
			{
				try
				{
					return Clu::Net::Converter::ToString(Clu::Viz::Wnd::GetPath(Clu::Viz::EEnvPath(eEnvPath)));
				}
			...
			Clu::Net::CluImage^ Env::LoadImage(System::String^ sFilename)
			{
				try
				{
					return gcnew Clu::Net::CluImage(Clu::Viz::Wnd::LoadImage(Clu::Net::Converter::ToIString(sFilename)));
				}
			...
			void Env::SaveImage(System::String^ sFilename, Clu::Net::CluImage^ xImage)
			{
				try
				{
					Clu::Viz::Wnd::SaveImage(Clu::Net::Converter::ToIString(sFilename), xImage->ToIImage());
				}
