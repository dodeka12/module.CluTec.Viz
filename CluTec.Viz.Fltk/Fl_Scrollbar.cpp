//
// "$Id: Fl_Scrollbar.cxx,v 1.3 2004/09/01 11:35:21 chp Exp $"
//
...
int Fl_Scrollbar::handle(int event) {
  ...
  case FL_KEYBOARD: {
	...
	v += ls;
	break;
/* Changed by Christian Perwass, 25.3.04.
	Don't want scrollbars to react to PageUp etc. since I need these
	keys for the presentation menu.
...
//
// End of "$Id: Fl_Scrollbar.cxx,v 1.3 2004/09/01 11:35:21 chp Exp $".
//
