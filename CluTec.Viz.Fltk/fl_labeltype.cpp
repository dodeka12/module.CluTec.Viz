//
// "$Id: fl_labeltype.cxx,v 1.2 2005/08/30 09:15:02 chp Exp $"
//
...
void
fl_icon_label(const Fl_Label* o, int X, int Y, int W, int H, Fl_Align align)
{
//  fl_font(o->font, o->size);
//  fl_color((Fl_Color)o->color);
  fl_draw(0, X, Y, W, H, align, o->image);
}
...
//
// End of "$Id: fl_labeltype.cxx,v 1.2 2005/08/30 09:15:02 chp Exp $".
//
