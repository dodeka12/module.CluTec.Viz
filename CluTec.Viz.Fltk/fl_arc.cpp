//
// "$Id: fl_arc.cxx,v 1.1 2004/02/18 16:10:36 chp Exp $"
//
...
void fl_arc(double x, double y, double r, double start, double end) {
  ...
  double epsilon; {
    double r1 = _hypot(fl_transform_dx(r,0), // Horizontal "radius"
		      fl_transform_dy(r,0));
    double r2 = _hypot(fl_transform_dx(0,r), // Vertical "radius"
		      fl_transform_dy(0,r));
...
//
// End of "$Id: fl_arc.cxx,v 1.1 2004/02/18 16:10:36 chp Exp $".
//
