//
// "$Id: Fl_XPM_Image.cxx,v 1.1 2004/02/18 16:10:31 chp Exp $"
//
...
Fl_XPM_Image::Fl_XPM_Image(const char *name) : Fl_Pixmap((char *const*)0) {
  ...
  while (fgets(buffer,MAXSIZE+20,f)) {
    ...
    while (*q != '\"' && myp < buffer+MAXSIZE) {
      ...
      case '\r':
      case '\n':
	fgets(q,(int)((buffer+MAXSIZE+20)-q),f); break; //TODO check if error is gone
      case 0:
	break;
      case 'x': {
	q++;
...
//
// End of "$Id: Fl_XPM_Image.cxx,v 1.1 2004/02/18 16:10:31 chp Exp $".
//
