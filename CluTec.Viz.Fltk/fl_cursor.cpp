//
// "$Id: fl_cursor.cxx,v 1.1 2004/02/18 16:10:37 chp Exp $"
//
...
//  if (c == FL_CURSOR_DEFAULT) c = FL_CURSOR_ARROW;
	...
	void Fl_Window::cursor(Fl_Cursor c, Fl_Color, Fl_Color)
	{
		...
		else
		{
			...
			switch (c)
			{
			case FL_CURSOR_ARROW:       n = IDC_ARROW;
				break;
			case FL_CURSOR_CROSS:       n = IDC_CROSS;
				break;
			case FL_CURSOR_WAIT:        n = IDC_WAIT;
				break;
			case FL_CURSOR_INSERT:      n = IDC_IBEAM;
				break;
			case FL_CURSOR_HELP:        n = IDC_HELP;
				break;
			case FL_CURSOR_HAND:        n = IDC_HAND;
				break;
			case FL_CURSOR_MOVE:        n = IDC_SIZEALL;
				break;
			case FL_CURSOR_N:
			case FL_CURSOR_S:
			case FL_CURSOR_NS:          n = IDC_SIZENS;
				break;
			case FL_CURSOR_NE:
			case FL_CURSOR_SW:
			case FL_CURSOR_NESW:        n = IDC_SIZENESW;
				break;
			case FL_CURSOR_E:
			case FL_CURSOR_W:
			case FL_CURSOR_WE:          n = IDC_SIZEWE;
				break;
			case FL_CURSOR_SE:
			case FL_CURSOR_NW:
			case FL_CURSOR_NWSE:        n = IDC_SIZENWSE;
				break;
			default:                    n = IDC_NO;
				break;
			}
	...
	void Fl_Window::cursor(Fl_Cursor c, Fl_Color, Fl_Color)
	{
		...
		switch (c)
		{
		case FL_CURSOR_CROSS:     i->cursor = GetCursor(crossCursor);
			break;
		case FL_CURSOR_WAIT:      i->cursor = GetCursor(watchCursor);
			break;
		case FL_CURSOR_INSERT:    i->cursor = GetCursor(iBeamCursor);
			break;
		case FL_CURSOR_N:
		case FL_CURSOR_S:
		case FL_CURSOR_NS:        i->cursor = &crsrNSptr;
			break;
		case FL_CURSOR_HELP:  i->cursor = &crsrHELPptr;
			break;
		case FL_CURSOR_HAND:  i->cursor = &crsrHANDptr;
			break;
		case FL_CURSOR_MOVE:  i->cursor = &crsrMOVEptr;
			break;
		case FL_CURSOR_NE:
		case FL_CURSOR_SW:
		case FL_CURSOR_NESW:  i->cursor = &crsrNESWptr;
			break;
		case FL_CURSOR_E:
		case FL_CURSOR_W:
		case FL_CURSOR_WE:    i->cursor = &crsrWEptr;
			break;
		case FL_CURSOR_SE:
		case FL_CURSOR_NW:
		case FL_CURSOR_NWSE:  i->cursor = &crsrNWSEptr;
			break;
		case FL_CURSOR_NONE:  i->cursor = &crsrNONEptr;
			break;
		case FL_CURSOR_ARROW:         i->cursor = &crsrARROWptr;
			break;
...
//
// End of "$Id: fl_cursor.cxx,v 1.1 2004/02/18 16:10:37 chp Exp $".
//
