//
// "$Id: fl_ask.cxx,v 1.2 2004/08/05 08:04:20 chp Exp $"
//
...
static char pcMsgWndTitle[201] = {0};
static const int iMsgWndTitleLength = 200;

Fl_Font fl_message_font_ = FL_HELVETICA;
uchar fl_message_size_ = 14;


void fl_message_title(const char *pcNewTitle)
{
	strncpy(pcMsgWndTitle, pcNewTitle, iMsgWndTitleLength);
}
...
static Fl_Window *makeform() {
 ...
 Fl_Window *w = message_form = new Fl_Window(410,103, pcMsgWndTitle);
 // w->clear_border();
 // w->box(FL_UP_BOX);
...
*/
  message->resize(50, 10, message_w, message_h);
  icon->resize(10, 10, 30, 30);
  icon->labelsize((uchar)(20));
  input->resize(50, 10 + message_h, message_w, 25);
...
//
// End of "$Id: fl_ask.cxx,v 1.2 2004/08/05 08:04:20 chp Exp $".
//
