//
// "$Id: fl_set_font.cxx,v 1.1 2004/02/18 16:10:41 chp Exp $"
//
...
void Fl::reset_fonts()
{
	for ( int i = 0; i < 16; ++i )
	{
		Fl_FontSize *pFontSize = fl_fonts[ i ].first;
		while ( pFontSize )
		{
			Fl_FontSize *pNext = pFontSize->next;
			delete pFontSize;
			pFontSize = pNext;
		}
...
//
// End of "$Id: fl_set_font.cxx,v 1.1 2004/02/18 16:10:41 chp Exp $".
//
