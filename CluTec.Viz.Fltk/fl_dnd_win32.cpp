//
// "$Id: fl_dnd_win32.cxx,v 1.1 2004/02/18 16:10:38 chp Exp $"
//
...
public:
  ...
  HRESULT STDMETHODCALLTYPE Drop( IDataObject *data, DWORD /*grfKeyState*/, POINTL pt, DWORD* /*pdwEffect*/) {
    ...
    if ( data->GetData( &fmt, &medium )==S_OK )
    {
      ...
      Fl::e_length = (int)strlen( (char*)stuff ); // min(strlen, len)
...
//
// End of "$Id: fl_dnd_win32.cxx,v 1.1 2004/02/18 16:10:38 chp Exp $".
//
