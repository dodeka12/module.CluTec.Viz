...
// file:      sta.h
//
// summary:   Declares the sta class
//
...
// STA Class Declaration -----------------------
	...
	public:
		...
		// Create 4D Vector
		static MultiV<CType> Vec(const CType& a1, const CType& a2, const CType& a3, const CType& a4);
		...
		// Make boost operator
		static MultiV<CType> Boost(const CType& a1, const CType& a2, const CType& a3, const CType& v);
	...
	private:
		...
		static short piGrades[16], piVITable[16], piDualTable[16];
		static short piGPTable[256], piIPTable[256], piOPTable[256];
	};
