...
void PGA<CType>::InitVars()
{
	...
	vL3[iL3] = 1;
	vL1I.SetStyle(m_MVStyle);
	vL1I[iL1I] = 1;
	vL2I.SetStyle(m_MVStyle);
	vL2I[iL2I] = 1;
	vL3I.SetStyle(m_MVStyle);
	vL3I[iL3I] = 1;
	vE1I.SetStyle(m_MVStyle);
	vE1I[iE1I] = 1;
	vE2I.SetStyle(m_MVStyle);
	vE2I[iE2I] = 1;
	vE3I.SetStyle(m_MVStyle);
	vE3I[iE3I] = 1;
	vE4I.SetStyle(m_MVStyle);
	vE4I[iE4I] = 1;
...
template<class CType>
bool PGA<CType>::AnalyzeMV(const MultiV<CType>& vX, CMVInfo<CType>& rMVI, bool bOPNS, CType fPrec)
{
	MultiV<CType> vA(vX);
	Mem<uint> mGList;
	int iGrades;
	...
	if (((iGrades = int(mGList.Count())) == 0) || (iGrades > 2)) { return false; }
...
template<class CType>
bool PGA<CType>::AnalyzeBlade(const MultiV<CType>& vY, CMVInfo<CType>& rMVI, bool bOPNS, CType fPrec)
{
	CType pfVec[4][4];
	Mem<uint> mGList;
...
template<class CType>
bool PGA<CType>::AnalyzeRotor(const MultiV<CType>& vX, CMVInfo<CType>& rMVI, CType fPrec)
{
	MultiV<CType> vU, vA;
	MemObj<MultiV<CType> > mvList;
